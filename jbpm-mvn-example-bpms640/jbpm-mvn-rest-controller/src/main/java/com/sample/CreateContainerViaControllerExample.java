...
public class CreateContainerViaControllerExample {
    ...
    public static void main(String[] args) {
        ...
        KieContainerResource deployedContainer = controllerClient.createContainer(KIESERVER_ID, CONTAINER_ID, containerToDeploy);

        System.out.println(deployedContainer);

        controllerClient.startContainer(KIESERVER_ID, CONTAINER_ID);
    }
